...
export const CallerControls = memo(function CallerControls({
  ...
  const Button = ({
    ...
    const variantClasses = {
      primary: 'bg-gradient-to-br from-loto-green to-loto-green-light text-paper hover:from-loto-green-light hover:to-loto-green',
      secondary: 'bg-gradient-to-br from-loto-gold to-loto-gold-light text-loto-green hover:from-loto-gold-light hover:to-loto-gold',
      danger: 'bg-gradient-to-br from-loto-red to-loto-red-light text-white hover:from-loto-red-light hover:to-loto-red',
    };
      ...
      <div className="pt-4 border-t border-loto-green/20">
        <div className="flex items-center justify-between text-sm">
          <div className="flex items-center gap-2">
            <div className={`w-2 h-2 rounded-full ${gameState === 'playing' ? 'bg-loto-green animate-pulse' : 'bg-gray-400'}`} />
            <span className="text-gray-600">
              Trạng thái: <span className="font-semibold text-loto-green">
                {gameState === 'waiting' ? 'Chờ bắt đầu' : gameState === 'playing' ? 'Đang chơi' : 'Đã kết thúc'}
              </span>
            </span>
          </div>
          {isCaller && (
