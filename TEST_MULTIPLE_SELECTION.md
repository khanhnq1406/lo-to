...
4. Top banner should say: "✓ Bạn đã chọn 3 phiếu dò: 1, 5, 9"
5. Should also say: "Bạn có thể chọn thêm 2 phiếu dò nữa"

**Deselect a Card:**

1. Click Card #1 again → Should deselect (remove green border)
2. Now should show: "✓ Bạn đã chọn 2 phiếu dò: 5, 9"
3. Should say: "Bạn có thể chọn thêm 3 phiếu dò nữa"

**Test Max Limit:**

1. Select cards: 1, 2, 3, 4, 5 (5 cards total)
2. Should say: "Bạn đã chọn đủ số lượng phiếu dò tối đa"
3. Try clicking Card #6 → Should show alert: "Bạn chỉ có thể chọn tối đa 5 phiếu dò!"
