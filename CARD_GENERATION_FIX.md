...
## Problem
Players were always seeing "Bạn chưa có thẻ nào. Hãy tạo thẻ mới để tham gia chơi!" (You don't have any cards) message after joining a room.
...
- "Tạo thẻ" (Create Cards) or "Tạo lại thẻ" (Regenerate Cards) button
...
3. Click "Tạo thẻ" or "Tạo lại thẻ"
...
- [ ] Click "Tạo lại thẻ" before game starts - should regenerate
