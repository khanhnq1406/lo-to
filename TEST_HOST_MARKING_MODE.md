...
4. Look for the toggle button in "Phiếu dò của bạn" section
...
3. Join the room
4. Select 1-3 cards
5. Look for the mode indicator in "Phiếu dò của bạn" section
6. You should see: **[⚡ Tự động đánh dấu]** (Light green badge, NOT clickable)

**Window 1 (Host):** 7. Click toggle to change to Manual mode

**Window 2 (Player):** 8. Watch the indicator - it should update automatically 9. Should now show: **[🖱️ Đánh dấu thủ công]** (Light blue badge)
...
**Both Windows:** 4. Watch your cards 5. Numbers should automatically turn **GOLD** when called 6. No clicking needed
...
**Both Windows:** 5. Called numbers should **PULSE YELLOW** (not auto-marked) 6. **Click on the pulsing numbers** to mark them 7. Clicked numbers turn **GOLD**
...
**Both Windows:** 5. Previous numbers stay gold (already marked) 6. New numbers pulse yellow (need clicking) 7. Click new numbers to mark them

**Window 1 (Host):** 8. **Switch back to Auto mode** 9. Next numbers auto-mark again
...
**Window 1 (Host):** 3. Toggle should work normally
...
Auto Mode:
┌─────────────────────────────────────────┐
│ Phiếu dò của bạn: 3   [⚡ Tự động đánh dấu]  │ ← Clickable, green
│                                         │
...
Manual Mode:
┌─────────────────────────────────────────┐
│ Phiếu dò của bạn: 3   [🖱️ Đánh dấu thủ công] │ ← Clickable, blue
│                                         │
...
Auto Mode:
┌─────────────────────────────────────────┐
│ Phiếu dò của bạn: 3   [⚡ Tự động đánh dấu]  │ ← Badge, light green
│                                         │
│ ⚡ Chế độ tự động: Số được gọi sẽ tự... │
└─────────────────────────────────────────┘
...
Manual Mode:
┌─────────────────────────────────────────┐
│ Phiếu dò của bạn: 3   [🖱️ Đánh dấu thủ công] │ ← Badge, light blue
│                                         │
│ 🖱️ Chế độ thủ công: Nhấn vào số trên...│
└─────────────────────────────────────────┘
```
